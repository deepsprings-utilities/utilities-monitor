...
- Optional:
  ...
  - `INGEST_LIST_SCAN_CAP` (default: `250000`) — how many keys may be scanned before checkpoint filtering and selecting up to `INGEST_BATCH_LIMIT` unprocessed objects. If your prefix has more keys than this cap, ingest fails by default to avoid silent starvation.
