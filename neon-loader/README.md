...
- Optional:
  ...
  - `INGEST_LIST_SCAN_CAP` (default: `250000`) — how many keys may be scanned before selecting the newest uncheckpointed `INGEST_BATCH_LIMIT` objects. If your prefix has more keys than this cap, ingest fails by default to avoid silent starvation.
