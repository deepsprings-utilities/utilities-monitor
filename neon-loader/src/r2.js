 ...
 * **lexicographic key order**; callers must checkpoint-filter this full scanned window before
 * applying their per-run processing cap, or older unprocessed keys can be stranded behind newer
 * already-checkpointed keys.
 *
 * @param {object} opts
 * @param {number} [opts.maxKeys] — minimum scan size when `listScanCap` is unset; default 200
