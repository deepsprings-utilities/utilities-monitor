 ...
 * R2/S3 returns keys in **lexicographic key order**; without this, each run could see the same
 * first N keys (all already checkpointed) and never reach newer uploads.
 *
 * @param {object} opts
 * @param {number} [opts.maxKeys] — process-per-run cap; used only as a minimum scan size
