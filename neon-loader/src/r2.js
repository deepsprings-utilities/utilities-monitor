 ...
 * window. R2/S3 returns keys in **lexicographic key order**; callers apply the processing
 * limit after checkpoint filtering so a backlog can continue draining past already-processed
 * newest objects.
 *
 * @param {object} opts
 * @param {number} [opts.maxKeys] — process-per-run target; scan cap is at least this value
