 ...
 * R2/S3 returns keys in **lexicographic key order**; callers need a LastModified-sorted
 * scan window before filtering checkpoints and applying their per-run process limit.
 *
 * @param {object} opts
 * @param {number} [opts.maxKeys] — minimum scan size, kept for compatibility with callers
