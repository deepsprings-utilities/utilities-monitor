 ...
 * **lexicographic key order**; without this, each run could see the same first N keys (all already
 * checkpointed) and never reach newer uploads.
 *
 * @param {object} opts
 * @param {number} [opts.maxKeys] — process-per-run limit; used as a lower bound for scan size
