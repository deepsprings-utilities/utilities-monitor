...
/**
 * Pick up to `maxObjects` uncheckpointed objects from an already-prioritized list.
 * The batch cap must be applied after checkpoint filtering, otherwise a run can
 * repeatedly select only recent already-processed keys and never reach backlog.
 *
 * @param {import("pg").Pool} pool
